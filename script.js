...
const CHANGELOG = [
    { date: '2025-08-11', title: 'Оновлення в реальному часі', desc: 'Інформація оновлюється на всіх пристроях.' },
    { date: '2025-08-10', title: 'Додано іконку «Що нового»', desc: 'Бічна шторка з історією змін, керування мишею та клавішею Esc.' },
    { date: '2025-08-08', title: 'Секція «Ідеї побачень»', desc: 'Слайдер + список, збереження в localStorage, відправка у форму.' }
];
